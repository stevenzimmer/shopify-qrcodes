...
export async function action({ request, params }: ActionFunctionArgs) {
  ...
  const errors = validateQRCode(data as any);
...
export default function QRCodeForm() {
  ...
  const [formState, setFormState] = useState<QRCode | {} | unknown>(qrCode);
        ...
        <Layout.Section>
          <PageActions
            ...
            primaryAction={{
              ...
              onAction: handleSave.bind(null, formState as QRCode),
            }}
          />
        </Layout.Section>
      </Layout>
